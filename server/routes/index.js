...
router.get('/api/todos/:todoId', authentication, todoAuthorization, TodoController.findOne)
router.put('/api/todos/:todoId', authentication, todoAuthorization, TodoController.update)
router.delete('/api/todos/:todoId', authentication, todoAuthorization, TodoController.delete)
